                ...
                <article class="overflow-hidden rounded-lg shadow-lg">
                    <div class="relative group">
                        ...
                        <span class="text-white absolute capitalize bottom-0 left-0 px-2 py-1 block bg-gradient-to-r from-gray-800">
                            <span>{{array_search($meal->category,\App\Models\Meal::$categories)}}</span>
                            <span>{{Carbon\Carbon::parse($meal->timing_from)->format('h:i a')}} - {{Carbon\Carbon::parse($meal->timing_to)->format('h:i a')}}</span>
                        </span>
